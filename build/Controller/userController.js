...
var _getDbConfig = require("../dbs/getDbConfig");
var _userDbConnect = _interopRequireDefault(require("../dbs/userDbConnect"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            //config파일 만들어오기
            dbConfig = (0, _getDbConfig.getDbConfig)(req.body);
            _context.prev = 1;
            _context.next = 4;
            return (0, _userDbConnect["default"])(req.body.dbkind, dbConfig);
          case 4:
            _context.next = 10;
            break;
          case 6:
